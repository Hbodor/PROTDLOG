...
module.exports = {
    GridItemSize, gridItemColor, ZNames, nRows0, nColumns0, border, effectiveBorder, Names, size, ZSpeed, ZLives, ZAttacks,
    ZPieces, Attacks, Bullets, Names, Prices, Lives, Pieces, movesColor
};